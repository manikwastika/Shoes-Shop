        ...
        <div class="mx-auto max-w-3xl space-y-6 sm:space-y-8">
          ...
          <div class="items-center gap-8 rounded-lg border border-gray-200 bg-white p-6 shadow-sm sm:flex">
            ...
            >
              ...
              />
              <img
                class="hidden h-auto max-h-full w-full"
          ...
          <ol class="relative border-s border-gray-200">
            <li class="mb-10 ms-6">
              <span class="absolute -start-2.5 flex h-5 w-5 items-center justify-center rounded-full bg-primary-100 ring-8 ring-white">
                <svg
              ...
              <h3 class="mb-0.5 mt-2 text-lg font-semibold text-primary-800">
                Your request has been registered
              </h3>
              <p class="text-base font-normal text-primary-700">
            ...
            <li class="mb-10 ms-6">
              <span class="absolute -start-2.5 flex h-5 w-5 items-center justify-center rounded-full bg-gray-100 ring-8 ring-white">
                <svg
              ...
              <h3 class="mb-1.5 text-lg font-semibold leading-none text-gray-900">
          ...
          <div class="sm:flex items-center sm:space-x-4 space-y-4 sm:space-y-0">
            ...
            <button
              type="button"
              class="w-full sm:w-auto flex justify-center items-center rounded-lg bg-red-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300"
            >
              <svg
